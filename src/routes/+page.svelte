...
<div class="text-lg">
	...
	<Block size="max-w-4xl" class="text-base text-gray-600">
		<em><strong>Performance of frontier models under ABBEL.</strong></em> We compare ABBEL 
		with standard multi-step interaction (Vanilla) and belief prompting approaches. Even 
		the strongest models fail to generate accurate, compact and sufficient belief states 
	...
	<Block>
		<p class="pb-4">
			...
			with interaction steps, the belief lengths grow much more slowly, even decreasing in some 
			environments as possibilities are ruled out.
		</p>
	</Block>
	<Block size="max-w-5xl" padding="pb-0">
	...
	<Block size="max-w-4xl" class="text-base text-gray-600">
		...
		Average length of beliefs generated under ABBEL compared to full interaction histories 
		across different environments and models.
	</Block>
	<!-- END EVALUATION -->
